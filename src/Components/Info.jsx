...
import nccImg from "/nccnepal.png"
    ...
    <>
      ...
      <section id="info" className="bg-slate-200 px-14 mb-8 mt-4 py-12">
        <div className="w-full">
          ...
          <div className=" grid grid-cols-2 w-full place-items-center justify-center">
            <img className="w-36 h-full" src={nccImg} />
            <img
              className="w-36 h-20"
              src="https://static1.squarespace.com/static/5a1f012fc027d8b65276b7e4/t/5a1f1cf5f9619ad38acd79c9/1511988481093/216549---Everest---Logo---Hospice.png"
            />
          </div>
          {/* </div> */}
        </div>
