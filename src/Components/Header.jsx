...
import logoImg from "/logoncc.png";

const Header = () => {
    const returnedToken = null; // localStorage.getItem("token");
    function checkPage() {
    ...
    return (
        <>
            <nav
                className={`overflow-visible top-0  left-0 fixed z-[99] w-full  bg-opacity-40 dark:bg-gray-900 text-[18px]`}
                onClick={checkPage}
            >
                <div
