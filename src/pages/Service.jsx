...
const Service = () => {
    ...
    const limitedServices = isHomePage ? card_data.slice(0, 6) : card_data;
    return (
        <div className={`${isHomePage ? "pt-12" : "pt-20 pb-12"} lg:px-24`}>
            {/* TITLE */}
            <div className="flex items-center mb-8">
                <div
                    className={`h-[2px] bg-gradient-to-r from-transparent via-red-50 to-[#F11a22] flex-grow shadow-md shadow-white`}
                ></div>
                <span className={`mx-2 font-semibold text-3xl text-[#194897] overflow-visible`}>
                    Our Services
                </span>
                <div
